...
{
	StreamableManager.RequestAsyncLoad(BP_WhiteJol.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_BlackJol.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_WhiteCha.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_BlackCha.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_WhiteMa.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_BlackMa.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_WhiteSang.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_BlackSang.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_WhitePo.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_BlackPo.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_WhiteJang.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_BlackJang.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_WhiteSa.ToSoftObjectPath());
	StreamableManager.RequestAsyncLoad(BP_BlackSa.ToSoftObjectPath());
}
...
AKCPiece* AKCSpawnManager::SpawnSpecificActor(EPieceKinds Kind, EPieceTeam Team, FVector SpawnLocation)
{
	...
	case EPieceKinds::JOL:
		...
		case EPieceTeam::WHITE:
			return Cast<AKCPiece>(CustomSpawnActor(BP_WhiteJol, SpawnLocation, FRotator(0.0f, 0.0f, 0.0f), SpawnParameters));
			break;
		case EPieceTeam::BLACK:
			return Cast<AKCPiece>(CustomSpawnActor(BP_BlackJol, SpawnLocation, FRotator(0.0f, 180.0f, 0.0f), SpawnParameters));
			break;
		}
		break;
	case EPieceKinds::SA:
		...
		{
		case EPieceTeam::WHITE:
			return Cast<AKCPiece>(CustomSpawnActor(BP_WhiteSa, SpawnLocation, FRotator(0.0f, 0.0f, 0.0f), SpawnParameters));
			break;
		case EPieceTeam::BLACK:
			return Cast<AKCPiece>(CustomSpawnActor(BP_BlackSa, SpawnLocation, FRotator(0.0f, 180.0f, 0.0f), SpawnParameters));
			break;
		}
		break;
	case EPieceKinds::SANG:
		...
		{
		case EPieceTeam::WHITE:
			return Cast<AKCPiece>(CustomSpawnActor(BP_WhiteSang, SpawnLocation, FRotator(0.0f, 0.0f, 0.0f), SpawnParameters));
			break;
		case EPieceTeam::BLACK:
			return Cast<AKCPiece>(CustomSpawnActor(BP_BlackSang, SpawnLocation, FRotator(0.0f, 180.0f, 0.0f), SpawnParameters));
			break;
		}
		break;
	case EPieceKinds::MA:
		...
		{
		case EPieceTeam::WHITE:
			return Cast<AKCPiece>(CustomSpawnActor(BP_WhiteMa, SpawnLocation, FRotator(0.0f, 0.0f, 0.0f), SpawnParameters));
			break;
		case EPieceTeam::BLACK:
			return Cast<AKCPiece>(CustomSpawnActor(BP_BlackMa, SpawnLocation, FRotator(0.0f, 180.0f, 0.0f), SpawnParameters));
			break;
		}
		break;
	case EPieceKinds::PO:
		...
		{
		case EPieceTeam::WHITE:
			return Cast<AKCPiece>(CustomSpawnActor(BP_WhitePo, SpawnLocation, FRotator(0.0f, 0.0f, 0.0f), SpawnParameters));
			break;
		case EPieceTeam::BLACK:
			return Cast<AKCPiece>(CustomSpawnActor(BP_BlackPo, SpawnLocation, FRotator(0.0f, 180.0f, 0.0f), SpawnParameters));
			break;
		}
		break;
	case EPieceKinds::CHA:
		...
		{
		case EPieceTeam::WHITE:
			return Cast<AKCPiece>(CustomSpawnActor(BP_WhiteCha, SpawnLocation, FRotator(0.0f, 0.0f, 0.0f), SpawnParameters));
			break;
		case EPieceTeam::BLACK:
			return Cast<AKCPiece>(CustomSpawnActor(BP_BlackCha, SpawnLocation, FRotator(0.0f, 180.0f, 0.0f), SpawnParameters));
			break;
		}
		break;
	case EPieceKinds::JANG:
		...
		{
		case EPieceTeam::WHITE:
			return Cast<AKCPiece>(CustomSpawnActor(BP_WhiteJang, SpawnLocation, FRotator(0.0f, 0.0f, 0.0f), SpawnParameters));
			break;
		case EPieceTeam::BLACK:
			return Cast<AKCPiece>(CustomSpawnActor(BP_BlackJang, SpawnLocation, FRotator(0.0f, 180.0f, 0.0f), SpawnParameters));
			break;
		}
		break;
	}
...
AActor* AKCSpawnManager::CustomSpawnActor(TSoftClassPtr<AActor> InObject, const FVector& InLocation, const FRotator& InRotation, const FActorSpawnParameters InSpawnParam)
{
	if (InObject.IsPending())
	{
		InObject.LoadSynchronous();
	}

	if (InObject.IsNull() == false)
	{
		
	}

	return GetWorld()->SpawnActor<AActor>(InObject.Get(), InLocation, InRotation, InSpawnParam);
}
